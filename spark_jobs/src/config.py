...
class Config:
    ...
    def get_steam_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            "output_path": self.get("output_path", "data/steam_account", env_var="STEAM_OUTPUT_PATH")
        }
    ...
    def get_spark_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            "app_name": self.get("spark_app_name", "steam-account-processor", env_var="SPARK_APP_NAME"),
            "shuffle_partitions": self.get("spark_shuffle_partitions", "4", env_var="SPARK_SHUFFLE_PARTITIONS")
        }